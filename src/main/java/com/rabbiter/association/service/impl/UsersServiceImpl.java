...
public class UsersServiceImpl implements UsersService {
    ...
    public Boolean isRemove(String userId){
        ...
        Integer total = Math.toIntExact(membersDao.selectCount(qw));
...
//        qw.eq("user_name", userName);
        ...
        Users_Hom user = usersDao.getHomUserByName(userName);
    ...
    public Users_Hom getOne_Hom(String userId) {
        Users_Hom user = usersDao.getOne_Hom(userId);
    ...
    public String getAvatar_Hom(String userId) {
        String avatar = usersDao.getAvatar_Hom(userId);
        return avatar;
    }
    ...
    public void addUserAvatar_Hom(String userId) {
        usersDao.addUserAvatar_Hom(userId);
    }
