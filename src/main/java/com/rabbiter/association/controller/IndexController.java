...
public class IndexController extends BaseController {
    ...
    public R getNoticeList(String token){
        ...
        List<Notices_Hom> list = noticesService.getSysNotices();
    ...
    @GetMapping("/club/notices")
    @ResponseBody
    public R getClubList(String token){
    ...
    @PostMapping("/login_Hom")
    @ResponseBody
    public R login_Hom( @RequestParam("userName") String userName,  @RequestParam("passWord")String passWord){

        Log.info("鸿蒙系统用户登录，用户名：{}， 用户密码：{}", userName, passWord);

        Users_Hom user = usersService.getUserByUserName_Hom(userName);
    ...
    @GetMapping("/info_Hom")
    @ResponseBody
    public R info_Hom(String token){

        Users_Hom user = usersService.getOne_Hom(cacheHandle.getUserInfoCache(token));
